		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "zcursoragapp5",
									"targetURL": "#zcursoragapp5zcursoragapp5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcursoragapp5zcursoragapp5-display": {
								"semanticObject": "zcursoragapp5zcursoragapp5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcursoragapp5.zcursoragapp5",
									"url": sap.ui.require.toUrl("zcursoragapp5/zcursoragapp5")
								}
							}
						}
					}
